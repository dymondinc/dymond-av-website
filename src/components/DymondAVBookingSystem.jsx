  ...
  return (
    <div className="bg-transparent text-white">
      ...
      <div className="container mx-auto px-4 md:px-6 pb-8">
        <div className="flex items-center justify-between mb-2 overflow-x-auto no-scrollbar gap-3">
          {steps.map((step, index) => (
            <span key={index} className={`text-xs md:text-sm whitespace-nowrap ${index + 1 <= currentStep ? 'text-blue-400 font-medium' : 'text-gray-500'}`}>
              {step}
            </span>
          ))}
        </div>
      ...
      {currentStep === 1 && (
            ...
            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
              ...
              <div className="space-y-4">
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full p-3 bg-black/60 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  required
                >
                ...
                {formData.eventDate && (
                  <div className={`p-2 rounded text-sm ${
                    ...
                    availabilityStatus === 'past' ? 'bg-white/5 text-white/60 border border-white/10' :
        ...
        {/* Step 2 and beyond containers re-styled */}
        {currentStep === 2 && (
          <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-6">
              <div className="bg-white/5 p-4 md:p-6 rounded-xl border border-blue-500/40">
                ...
                <div className="space-y-3">
                  {Object.entries(packages).map(([key, pkg]) => (
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-lg border transition ${selectedPackage === key ? 'border-blue-500 bg-blue-500/10' : 'border-white/10 hover:border-white/20'}`}
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="font-medium">{pkg.name}</div>
                          <div className="text-white/60 text-sm">Includes: {pkg.includes.join(', ')}</div>
                        </div>
                        <div className="text-blue-400 font-semibold">${pkg.price}</div>
                      </div>
                    </button>
                  ))}
                </div>
              </div>
              {/* Add-ons, lighting, screens, etc styled similarly */}
              <div className="bg-white/5 p-4 md:p-6 rounded-xl border border-white/10">
                ...
                <div className="space-y-3">
                  {Object.entries(addOns).filter(([key, item]) => item.category === 'lighting').map(([key, item]) => (
                    <div key={key} className="flex items-center justify-between p-3 bg-black/60 rounded-lg border border-white/10">
                      <div className="flex-1">
                        ...
                        <div className="text-blue-400 font-semibold">
                          ...
                          {key === 'uplighting' && formData.uplighting >= 8 && (
                            <span className="text-xs text-white/60 line-through ml-2">${item.price}</span>
                          )}
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
                        <button 
                          ...
                          className="w-8 h-8 bg-black/60 hover:bg-black/50 disabled:opacity-50 rounded flex items-center justify-center transition-colors"
                        >
                          <Minus size={16} />
                        </button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                <div className="px-4 py-3 border-b border-white/10 text-white/70 text-sm">Live Visualizer</div>
                <div className="h-[440px]">
                  <Suspense fallback={<div className="w-full h-full flex items-center justify-center text-white/60">Loading…</div>}>
              ...
              <div className="bg-white/5 p-4 md:p-6 rounded-xl border border-white/10">
                ...
                <div className="flex justify-between text-xl font-bold pt-4 border-t-2 border-white/10">
                  <span>Total:</span>
      ...
      {currentStep === 5 && (
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-white/5 p-6 rounded-xl border border-white/10">
            ...
            <div className="text-sm text-white/60 mb-4 max-h-40 overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-white/10 rounded-lg p-4 bg-black/60">
                  <canvas
                    ref={canvasRef}
                    width={400}
                    height={150}
                    className="border border-white/10 cursor-crosshair w-full touch-none bg-black/60"
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-xs text-white/60">Sign above with your mouse or finger</span>
                    <button
                      type="button"
                      onClick={clearSignature}
                      className="text-xs bg-black/60 hover:bg-black/50 text-white px-3 py-1 rounded"
                    >
                      Clear
                    </button>
                  </div>
                  ...
                  <div className="bg-black/60 p-3 rounded border border-white/10">
                    ...
                    <div className="mt-2 border-t border-white/10 pt-2">
                      <img 
                        ...
                        alt="Signature" 
                        className="max-h-16 border border-white/10"
                      />
                    </div>
                  </div>
                </div>
      ...
      {/* Navigation Buttons */}
      <div className="container mx-auto px-4 md:px-6 flex justify-between mt-8">
        <button
          onClick={prevStep}
          disabled={currentStep === 1}
          className="px-6 py-3 bg-black/60 text-white rounded-lg hover:bg-black/50 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Previous
        </button>
        ...
        {currentStep < 5 ? (
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="px-6 py-3 bg-black/60 text-white rounded-lg hover:bg-black/50 flex items-center"
            >
              <FileText className="mr-2" size={20} />
              Preview Contract
            </button>
      ...
      {showFullContract && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-black/60 rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-white/10">
            <h3 className="text-lg font-semibold mb-4 flex items-center text-blue-400">
              <FileText className="mr-2" />
              Complete Contract Preview
            </h3>
            <div className="bg-black/60 p-6 rounded border border-white/10">
              <pre className="whitespace-pre-wrap text-sm font-mono leading-relaxed text-white/60">
                {generateContract()}
              </pre>
              ...
              {signatureExists && (
                <div className="mt-6 pt-4 border-t border-white/10">
                  ...
                  <img 
                    ...
                    className="border border-white/10 p-2 bg-black/60 max-h-20"
                  />
                </div>
              )}
            </div>
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-black/60 text-white rounded hover:bg-black/50"
              >
                Close
              </button>
            </div>
      ...
      {showPricing && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-black/60 rounded-lg p-6 max-w-2xl w-full max-h-96 overflow-y-auto border border-white/10">
            <h3 className="text-lg font-semibold mb-4 flex items-center text-blue-400">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full p-2 bg-black/60 border border-white/10 rounded text-white/60"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  readOnly
                  rows="12"
                  className="w-full p-2 bg-black/60 border border-white/10 rounded text-white/60 text-sm"
                />
              </div>
              <div className="flex space-x-3">
                <button
      ...
      {showContract && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-black/60 rounded-lg p-8 max-w-md text-center border border-white/10">
